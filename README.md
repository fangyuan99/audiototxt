...
### What it does
Transcribe audio to text with Google Generative AI (Gemini). Optionally fetch audio from video sites via `yt-dlp` and then transcribe. Default model is `gemini-2.5-flash`.
